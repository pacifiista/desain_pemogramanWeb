...
?>
        ...
        <section>
            ...
            <p style="margin-bottom: 1rem; color: #555;">
                ...
                Catatan: mulai Jobsheet 8, tombol ini hanya mereset data sesi (seperti pesan flash) --
                data buku &amp; anggota kini tersimpan di database dan <strong>tidak</strong> ikut terhapus oleh session_destroy().
            </p>
